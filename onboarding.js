  ...
  const SLIDES = [
    {
      ...
      body: 'HTMLは用意された状態から、JavaScriptを書いて動きを作る練習ができるサイトです。まずは軽く使い方を見ていきましょう。'
    },
    {
      title: '① 問題一覧から選ぶ',
    ...
    {
      title: '② コードを書いて実行',
      body: '与えられたHTMLを見ながら、右側のエディタにJavaScriptを書いて「実行する」を押すと、その場でプレビューが動きます。'
    },
    {
      title: '③ その場で自動採点',
    ...
    {
      title: '近日公開: AIコードレビュー',
      body: '書いたコードをAIに送って、より良い書き方や改善のヒントをもらえる機能を準備中です。お楽しみに。'
    }
  ];
