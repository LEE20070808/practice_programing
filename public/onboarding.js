...
(function () {
  const SLIDES = [
    ...
    {
      title: '② AIにコードを書いてもらう',
      body: 'このサイトのゴールは「自分で書けること」ではなく「読めること」です。与えられたHTMLを見ながら、AIに指示を出してJavaScriptを書いてもらい、それをエディタに貼り付けてみましょう。'
    },
    {
      title: '③ AIにレビューしてもらう',
      body: '貼り付けたコードをAIに送ると、より良いコードの例と一緒に「そのコードを引き出すにはどんなプロンプトを書けばよかったか」のヒントがもらえます。ここがこのサイトの一番の特徴です。'
    },
    {
      title: '④ その場で自動採点',
